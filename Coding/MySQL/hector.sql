...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 01-12-2020 a las 00:20:16
...
--
-- Estructura de tabla para la tabla `zambrano`
--

CREATE TABLE `zambrano` (
  `id` int(11) NOT NULL,
  `nombre` varchar(11) COLLATE utf8_spanish_ci NOT NULL,
  `apellido` varchar(11) COLLATE utf8_spanish_ci NOT NULL,
  `covid` tinyint(1) NOT NULL DEFAULT 0
...
--
-- Indices de la tabla `zambrano`
--
ALTER TABLE `zambrano`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT de la tabla `zambrano`
--
ALTER TABLE `zambrano`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT;
COMMIT;
